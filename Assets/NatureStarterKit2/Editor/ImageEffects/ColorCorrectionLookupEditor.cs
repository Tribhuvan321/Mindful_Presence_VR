        ...
        public override void OnInspectorGUI()
        {
            ...
            if (tex && (target as ColorCorrectionLookup).basedOnTempTex != AssetDatabase.GetAssetPath(tex))
            {
                ...
                else if (GUILayout.Button("Convert and Apply"))
                {
                    ...
                    // Replacing the obsolete textureFormat check with textureCompression
                    ...
                    if (doImport)
                    {
                        ...
                        // Updated: We no longer set textureFormat, instead, we use textureCompression
                        textureImporter.textureCompression = TextureImporterCompression.Uncompressed;  // This replaces setting textureFormat
